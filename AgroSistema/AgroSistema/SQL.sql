...
-- --------------------------------------------------
-- Date Created: 08/04/2013 17:03:55
...
IF OBJECT_ID(N'[dbo].[FK_UsuariosAcesso]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Acesso] DROP CONSTRAINT [FK_UsuariosAcesso];
GO
...
IF OBJECT_ID(N'[dbo].[Acesso]', 'U') IS NOT NULL
...
CREATE TABLE [dbo].[Fazendas] (
    ...
    [Telefone] nvarchar(max)  NOT NULL,
    [Encarregado] nvarchar(max)  NOT NULL,
